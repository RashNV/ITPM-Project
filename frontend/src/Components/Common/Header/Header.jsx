                ...
                <ProSidebar collapsed={false}>
                    <SidebarContent>
                        <Menu iconShape="square">
                            ...
                            <MenuItem active={strUseApp === "Report" ? true : false} icon={<FiTrello />} onClick={() => setUseApp("stock")}>
                                STOCK
                                <Link to="/stock" />
                            </MenuItem>
                            <MenuItem active={strUseApp === "Report" ? true : false} icon={<FiTrello />} onClick={() => setUseApp("brand")}>
                                BRAND MANAGEMENT
                                <Link to="/brand" />
                            </MenuItem>
                        </Menu>
